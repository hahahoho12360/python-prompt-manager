...
### 스마트 물병 브랜드 레퍼런스 이미지 제작

Premium product reference image of a fictional smart water bottle named LUMO. Matte translucent white cylindrical 
...
시험 응시자의 성명과 점수, 이메일 주소를 구글폼으로 결과를 입력 받아서 80점 이상은 합격으로, 80점 미만은 재응시로 회신하는 이메일을 자동 발송하는 워크플로우를 MAKE에서 구성하는 방법과 절차에 대해 알려주세요.
